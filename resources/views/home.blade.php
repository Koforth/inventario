            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead text-muted mb-4">
                        Desde aqui puedes consultar el catalogo, administrar productos y registrar movimientos segun tus permisos.
                    </p>
                ...
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="bg-light rounded-3 p-4">
                        ...
                        @if (auth()->user()->primaryRoleName())
                            <span class="badge text-bg-success">{{ auth()->user()->primaryRoleName() }}</span>
                        @endif
                    </div>
                </div>
            </div>
